...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//1.정수 byte,short,long,int
		//byte = 1byte
		byte 바이트 = 1;
		System.out.println(바이트);
		System.out.println("바이트");
		//파일을 저장할 때 키보드에서 ctrl+s를 눌러주면 저장
		byte bt = 2;
		...
		//long 자료형 선언 선언이름 lng lng안에 숫자 2 넣고 출력하기
		long lng = 2;
		...
		//2.문자
			...
			//문자를 나타내는 char은 '' 작은 따옴표를 사용 해서 표현
			//"" 큰 따옴표는 String 문자열을 나타내는 표현
			char myChar2 = 'b';
			System.out.println(myChar2);
			//char에는 하나의 문자만 담을 수있기때문에
			//A나 B중 둘 줄 하나만 작성가능
			/*
			 * char myChar3 ='AB';
			 *  char myChar4='ABC';
			...
			//System.out.println(name);
			  ...
			  */
		      ...
		      System.out.println(geeting);//안녕하세요
		      ...
		      //double은 크기가 float 보다 크고 애초에 double을 넣으려 했기를 때문에
	          //뒤에 다른 수식을 붙이지 않아도 사용할 수 있음
	          double dd1 =3.14;
	          System.out.println("double dd1:"+dd1);
	          
	          //5.논리형
	          //boolean을 사용하여 true인지 false인지 표현할 수 있음
	          //나중에 알고리즘이나 if for while 문을 사용할때 자주 사용
	          boolean isTrue=true;
	          ...
	          age = "20"; //age의 값을 20으로 변경
	          System.out.println("그런데 24년이 되면서"+age+"살 되었다");
