...
public class OperatorPre2 {
	...
	public static void method1() {
		...
		public static void method2() {
			...
			int e= ++c;//c+1=c 넣겠다 해줬기 대문에 c =12
		...
		public static void method3() {
			...
			System.out.println("그렇군요, 그러면 동일하게 나눠 가질 사탕의 갯수는 몇개 입니까?:");
			
			//한 사람당 동일하게 나눠가질 사탕의 개수 = 총 사탕의 개수/총 인원의 수
				int 			perPerson = candies / people;
			
			//1인당 동일하게 나눠가진 사탕의 개수
