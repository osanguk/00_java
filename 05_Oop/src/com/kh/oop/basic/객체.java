...
/*
 ...
 Object - Oriented - Programming
  ...
  컴퓨터 프로그램을 사용할 때
  어떤 데이터를 입력 받아서 순서대로 처리 결과를 출력하는 부품들의 조합
  	...
  	클래스(class): 객체를 만들기 위한 템플릿 또는 설계도
  		...
  		EX) 객체.java
 				...
 				필드 : 변수명을 작성하는 콩간
 					...
 					ex)[접근 제한자] [반환 타입] [메서드 이름] (매게변수 리스트){
 						메서드 이름에서 실행할 내용 작성
 						}
					public	void	practice	(  ) {
						System.in.outprintln("안녕하세요.");
						}
